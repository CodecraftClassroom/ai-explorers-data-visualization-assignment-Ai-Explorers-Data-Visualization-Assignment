...
import os
import pandas as pd
from visualizations import load_fifa_data, plot_fifa_data, load_flight_data, plot_flight_data

class TestVisualizations(unittest.TestCase):

    def setUp(self):
        self.fifa_file = 'fifa_data.csv'
        self.flight_file = 'flight_data.csv'
    ...
    def test_load_fifa_data(self):
        data = load_fifa_data(self.fifa_file)
        self.assertIsInstance(data, pd.DataFrame)

    def test_load_flight_data(self):
        data = load_flight_data(self.flight_file)
        self.assertIsInstance(data, pd.DataFrame)
